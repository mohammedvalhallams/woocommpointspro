...
register_widget( 'Wps_Wpr_Custom_Widget' );
 ...
 */
class Wps_Wpr_Custom_Widget extends WP_Widget {
	...
	public function __construct() {
		$widget_options = array(
			'classname'   => 'wps_wpr_custom_widget',
			'description' => 'My Point',
		);
		parent::__construct( 'wps_wpr_custom_widget', 'Points and Rewards', $widget_options );
	}
	...
	public function widget( $args, $instance ) {
		...
		if ( isset( $user_ID ) && ! empty( $user_ID ) ) {
			...
			if ( isset( $wps_wpr_mem_expr ) && ! empty( $wps_wpr_mem_expr ) ) {
				echo '<div><strong>' . esc_html( $membershipexpiration ) . ' ' . esc_html( $wps_wpr_mem_expr ) . '</strong></div>';
			}
